...
export default function AboutSection() {
  return (
    ...
    >
      <Grid container spacing={6} pb={6} pl={10}>
        <Grid item lg={6} md={6}>
          <div className="about__section-content">
            ...
            <Typography variant="body1" className="section__description">
              ...
              for all your travel needs. Our fleet includes a wide range of cars
              from economy to luxury, ensuring we have the perfect vehicle for
